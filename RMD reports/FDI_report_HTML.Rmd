...
tableA <- read.table("D:\\COISPA\\QualiTrain\\Practical sessions\\scripts\\dummy datasets\\fdi_a_catch.csv", sep = ";", header = TRUE)
tableG <- read.table("D:\\COISPA\\QualiTrain\\Practical sessions\\scripts\\dummy datasets\\fdi_g_effort.csv", sep = ";", header = TRUE)
tableH <- read.table("D:\\COISPA\\QualiTrain\\Practical sessions\\scripts\\dummy datasets\\fdi_h_spatial_landings.csv", sep = ";", header = TRUE)
tableI <- read.table("D:\\COISPA\\QualiTrain\\Practical sessions\\scripts\\dummy datasets\\fdi_i_spatial_effort.csv", sep = ";", header = TRUE)
tableJ <- read.table("D:\\COISPA\\QualiTrain\\Practical sessions\\scripts\\dummy datasets\\fdi_j_capacity.csv", sep = ";", header = TRUE)
...
if (exists("tableA")) {
  if (class(tableA) == "data.frame") {
    if (nrow(tableA) > 0) {
      colnames(tableA) <- tolower(colnames(tableA))
      check_tableA <- TRUE
...
if (check_tableA) {
  cat("\n## Check the presence of duplicated or disaggregated records\n")
  cat("\nFDI catch data (table A) were checked for the presence of duplicated or disaggregated records. In particular, it was checks whether the combination of the first 20 columns generates duplicate or disaggregated records.\n")

  res <- suppressMessages(check_RD_FDI_A(data = tableA, verbose = FALSE))

  if (length(res) > 0) {
    l <- length(res)
    cat(paste0("\n\n\n- ", l, " duplicated or disaggregated record/s was/were detected in the FDI catch table A\n\n\n"))
    ...
    cat("\n\n\n")
    cat(paste0("\n_Table of duplicated or disaggregated records in FDI catch table (Table A)_\n"))
    print(df %>% kable("html") %>% kable_styling(font_size = 11) %>% kable_classic(full_width = TRUE))
    cat("\n\n\n")
  } else {
    cat(paste0("\n\n\n- No duplicated or disaggregated records were detected in the FDI catch table A\n\n\n"))
  }
} # check_TableA
```
...
if (exists("tableG")) {
  if (class(tableG) == "data.frame") {
    if (nrow(tableG) > 0) {
      colnames(tableG) <- tolower(colnames(tableG))
      check_tableG <- TRUE
...
if (check_tableG) {
  cat("\n## Check the presence of duplicated or disaggregated records\n")
  cat("\nFDI effort data (table G) were checked for the presence of duplicated or disaggregated records. In particular, it was checked whether the combination of the first 16 columns generates duplicated or disaggregated records.\n")

  res <- suppressMessages(check_RD_FDI_G(data = tableG, verbose = FALSE))

  if (length(res) > 0) {
    l <- length(res)
    cat(paste0("\n\n\n- ", l, " duplicated or disaggregated record/s was/were detected in the FDI effort table G\n\n\n"))
    ...
    cat("\n\n\n")
    cat(paste0("\n_Table of duplicated or disaggregated records in FDI effort table (Table G)_\n"))
    print(df %>% kable("html") %>% kable_styling(font_size = 11) %>% kable_classic(full_width = TRUE))
    cat("\n\n\n")
  } else {
    cat(paste0("\n\n\n- No duplicated or disaggregated records were detected in the FDI effort table G\n\n\n"))
  }
} # check_TableA
```
...
if (exists("tableH")) {
  if (class(tableH) == "data.frame") {
    if (nrow(tableH) > 0) {
      colnames(tableH) <- tolower(colnames(tableH))
      check_tableH <- TRUE
...
if (check_tableH) {
  cat("\n## Check the presence of duplicated or disaggregated records\n")
  cat("\nFDI Landings by rectangle data (table H) were checked for the presence of duplicated or disaggregated records. In particular, it was checked whether the combination of the first 20 columns generates duplicated or disaggregated records.\n")

  res <- suppressMessages(check_RD_FDI_H(data = tableH, verbose = FALSE))

  if (length(res) > 0) {
    l <- length(res)
    cat(paste0("\n\n\n- ", l, " duplicated or disaggregated record/s was/were detected in the FDI Landings by rectangle table H\n\n\n"))
    ...
    cat("\n\n\n")
    cat(paste0("\n_Table of duplicated or disaggregated records in FDI Landings by rectangle table (Table H)_\n"))
    print(df %>% kable("html") %>% kable_styling(font_size = 11) %>% kable_classic(full_width = TRUE))
    cat("\n\n\n")
  } else {
    cat(paste0("\n\n\n- No duplicated or disaggregated records were detected in the FDI Landings by rectangle table H\n\n\n"))
  }
} # check_TableH
```
...
if (exists("tableI")) {
  if (class(tableI) == "data.frame") {
    if (nrow(tableI) > 0) {
      colnames(tableI) <- tolower(colnames(tableI))
      check_tableI <- TRUE
...
if (check_tableI) {
  cat("\n## Check the presence of duplicated or disaggregated records\n")
  cat("\nFDI Effort by rectangle data (table I) were checked for the presence of duplicated or disaggregated records. In particular, it was checked whether the combination of the first 20 columns generates duplicated or disaggregated records.\n")

  res <- suppressMessages(check_RD_FDI_I(data = tableI, verbose = FALSE))

  if (length(res) > 0) {
    l <- length(res)
    cat(paste0("\n\n\n- ", l, " duplicated or disaggregated record/s was/were detected in the FDI Effort by rectangle table I\n\n\n"))
    ...
    cat("\n\n\n")
    cat(paste0("\n_Table of duplicated or disaggregated records in FDI Effort by rectangle table (Table I)_\n"))
    print(df %>% kable("html") %>% kable_styling(font_size = 11) %>% kable_classic(full_width = TRUE))
    cat("\n\n\n")
  } else {
    cat(paste0("\n\n\n- No duplicated or disaggregated records were detected in the FDI Effort by rectangle table I\n\n\n"))
  }
} # check_TableI
```
...
if (exists("tableJ")) {
  if (class(tableJ) == "data.frame") {
    if (nrow(tableJ) > 0) {
      colnames(tableJ) <- tolower(colnames(tableJ))
      check_tableJ <- TRUE
...
if (check_tableJ) {
  cat("\n## Check the presence of duplicated or disaggregated records\n")
  cat("\nFDI Capacity and fleet segment effort data (table J) were checked for the presence of duplicated or disaggregated records. In particular, it was checked whether the combination of the first 20 columns generates duplicated or disaggregated records.\n")

  res <- suppressMessages(check_RD_FDI_J(data = tableJ, verbose = FALSE))

  if (length(res) > 0) {
    l <- length(res)
    cat(paste0("\n\n\n- ", l, " duplicated or disaggregated record/s was/were detected in the FDI Capacity and fleet segment effort table J\n\n\n"))
    ...
    cat("\n\n\n")
    cat(paste0("\n_Table of duplicated or disaggregated records in FDI Capacity and fleet segment effort table (Table J)_\n"))
    print(df %>% kable("html") %>% kable_styling(font_size = 11) %>% kable_classic(full_width = TRUE))
    cat("\n\n\n")
  } else {
    cat(paste0("\n\n\n- No duplicated or disaggregated records were detected in the FDI Capacity and fleet segment effort table J\n\n\n"))
  }
} # check_TableJ
```
