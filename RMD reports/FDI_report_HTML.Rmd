...
tableA <- read.coded.file("D:\\COISPA\\QualiTrain\\Practical sessions\\scripts\\dummy datasets\\fdi_a_catch.csv", sep = ";")
tableG <- read.coded.file("D:\\COISPA\\QualiTrain\\Practical sessions\\scripts\\dummy datasets\\fdi_g_effort.csv", sep = ";")
tableH <- read.coded.file("D:\\COISPA\\QualiTrain\\Practical sessions\\scripts\\dummy datasets\\fdi_h_spatial_landings.csv", sep = ";")
tableI <- read.coded.file("D:\\COISPA\\QualiTrain\\Practical sessions\\scripts\\dummy datasets\\fdi_i_spatial_effort.csv", sep = ";")
tableJ <- read.coded.file("D:\\COISPA\\QualiTrain\\Practical sessions\\scripts\\dummy datasets\\fdi_j_capacity.csv", sep = ";")
