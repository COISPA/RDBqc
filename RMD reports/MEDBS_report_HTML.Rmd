...
# Catch <- read.table("D:/OneDrive - Coispa Tecnologia & Ricerca S.C.A.R.L/QualiTrain/20230627_Practical_session/EWG2203/catch.csv", sep = ",", header = TRUE)
# Land <- read.table("D:/OneDrive - Coispa Tecnologia & Ricerca S.C.A.R.L/QualiTrain/20230627_Practical_session/EWG2203/landings.csv", sep = ",", header = TRUE)
Disc <- read.table("D:/OneDrive - Coispa Tecnologia & Ricerca S.C.A.R.L/QualiTrain/20230627_Practical_session/EWG2203/discards.csv", sep = ",", header = TRUE)
    ...
    for (s in 1:length(SPs)) {
      ...
      res <- suppressMessages(MEDBS_LFD(data = Land, data2=NA, type="l", MS = MS, GSA = GSAs[g], SP = SPs[s], OUT=FALSE, verbose = TRUE))
        ...
        for (x in 1:length(plots)) {
          if (plots_names[x,3]=="TOTAL LANDINGS") {
