...
Catch <-  read.coded.file("C:\\prova_rdbqc\\walter\\catch.csv", sep = ",") # Catch_tab_example
#Land <-  read.coded.file("C:\\prova_rdbqc\\walter\\landings.csv", sep = ",") #Landing_tab_example
#Disc <-  read.coded.file("C:\\prova_rdbqc\\walter\\discards.csv", sep = ",") #Discard_tab_example
#ML <- read.coded.file("C:\\prova_rdbqc\\walter\\ml.csv", sep = ",") #ML_tab_example 
#MA <- read.coded.file("C:\\prova_rdbqc\\walter\\ma.csv", sep = ",") # MA_tab_example
#SL <-  read.coded.file("C:\\prova_rdbqc\\walter\\srl.csv", sep = ",") #SL_tab_example
#SA <-  read.coded.file("C:\\prova_rdbqc\\walter\\sra.csv", sep = ",") #SA_tab_example
#GP <- read.coded.file("C:\\prova_rdbqc\\walter\\gp.csv", sep = ",") #GP_tab_example 
ALK <-  read.coded.file("C:\\prova_rdbqc\\walter\\alk.csv", sep = ",") #ALK_tab_example

SPs <- c("MUT","MTS") # "ARS", "HKE","SQR", "MUR", "MUT", 
MS <- "ITA"
GSAs <- "GSA 19"
end_year <- 2022
```
