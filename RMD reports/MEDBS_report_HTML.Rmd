...
Catch <-  read.coded.file("C:\\prova_rdbqc\\Catch_GSA_18.csv", sep = ";") # Catch_tab_example
Land <-  read.coded.file("C:\\prova_rdbqc\\Lnd_GSA_18.csv", sep = ";") #Landing_tab_example
Disc <-  read.coded.file("C:\\prova_rdbqc\\Disc_GSA_18.csv", sep = ";") #Discard_tab_example
ML <- read.coded.file("C:\\prova_rdbqc\\ML_GSA 18.csv", sep = ";") #ML_tab_example 
MA <- read.coded.file("C:\\prova_rdbqc\\MA_GSA 18.csv", sep = ";") # MA_tab_example
SL <-  read.coded.file("C:\\prova_rdbqc\\SRL_GSA 18.csv", sep = ";") #SL_tab_example
SA <-  read.coded.file("C:\\prova_rdbqc\\SRA_GSA 18.csv", sep = ";") #SA_tab_example
GP <- read.coded.file("C:\\prova_rdbqc\\GP_GSA 18.csv", sep = ";") #GP_tab_example 
ALK <-  read.coded.file("C:\\prova_rdbqc\\ALK_GSA 18 with errors.csv", sep = ";") #ALK_tab_example
