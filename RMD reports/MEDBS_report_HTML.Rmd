...
Disc <- read.csv("~/GitHub/RDBqc_appoggio/dataset/discards_BGR.csv") #read.table("./discards_gsa18.csv", sep = ";", header = TRUE)
...
if (check_ALK) {
  cat("\n## Presence of duplicated records\n")
  cat("\nData included in the ALK table were checked for the presence of duplicated records. The result of the check is here reported:\n")
