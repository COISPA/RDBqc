...
Catch$area <- "GSA 99"
Land = Landing_tab_example # read.table("D:\\Documents and Settings\\Utente\\Documenti\\GitHub\\RDBqc\\APPOGGIO\\Ioannis\\exported_data_GRC_landings.csv",sep=",",header=TRUE)# 
Land$area <- "GSA 99"
Disc =  Discard_tab_example # read.table("D:\\Documents and Settings\\Utente\\Documenti\\GitHub\\RDBqc\\APPOGGIO\\Ioannis\\exported_data_disc.csv",sep=",",header=TRUE)#
Disc$area <- "GSA 99"
ML = ML_tab_example
ML$area <- "GSA 99"
MA = MA_tab_example
...
if (check_Land) {
    cat("\n## Checks the presence of landing weights with zeros in landings\n")
...
if (check_Disc) {
    cat("\n## Checks the presence of length classes numbers with zeros in discards\n")
...
if (check_Disc) {
    cat("\n## Checks the presence of discard weights with zeros in discards\n")
...
if (check_Disc) {
    cat("\n## Checks the presence of discard weights with -1 in discards\n")
