...
The function checks the possible data inconsistency between landings and effort and returns a list where all the mismatches between landings and effort are reported.
