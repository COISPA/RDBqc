...
#' @examples EWG_yr_missing_length(data=landing,type="l",MS=c("ITA"),GSA=c("18"),SP="NEP")
#' @import tidyverse
...
#' @export EWG_yr_missing_length

EWG_yr_missing_length <- function (data,type,MS,GSA,SP) {
    ...
    if (FALSE) {
        ...
        EWG_yr_missing_length(data=landing, type="l",MS="ITA",GSA="18", SP="NEP")
