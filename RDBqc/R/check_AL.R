...
#' @export
#' @examples check_AL(data_ex,MS="ITA",GSA="GSA99",SP="Mullus barbatus",min_age=0,max_age=30)
#' @import ggplot2
#' @importFrom stats aggregate
#' @importFrom utils globalVariables
check_AL<-function(data,MS,GSA,SP,min_age=0,max_age=30, verbose=TRUE){

    ge<-Length_class<-Sex<-NULL
