...
#' @export EWG_check_duplicates
#' @author Alessandro Mannini <alessandro.mannini@@ec.europa.eu>
#' @author Walter Zupa <zupa@@coispa.it>
#' @author Isabella Bitetto <bitetto@@coispa.it>

EWG_check_duplicates <- function(data,type="l",MS,GSA,SP,verbose=TRUE) {
    if (FALSE) {
        data <- landing
        type <- "l"
        MS <- "ITA"
...
#       library(data.table)
        ...
        EWG_check_duplicates(data=data,type="l",MS="ITA",GSA=18,SP="NEP",verbose=FALSE)
    }
