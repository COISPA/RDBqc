...
#' @export EWG_disc_mean_weight
#'
#' @examples EWG_disc_mean_weight(disc=discards,MS="ITA",GSA=18,SP="MUT")
...
EWG_disc_mean_weight <- function(disc,MS,GSA,SP) {
    ...
    if (FALSE) {
        ...
        # verbose=TRUE
        disc=discards
        EWG_disc_mean_weight(disc=discards,MS="ITA",GSA=17,SP="MUT")
    }
