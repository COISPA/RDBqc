...
```
## Check AL 
This function reports for each year and and length class the number of age measurements in the dataset. Moreover, the function detects if the age data are in the range min_age-max_age. 
```{r input2}
