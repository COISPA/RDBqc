...
#' Check empty fields in FDI A and H table
#'
...
#' FDI_cross_checks_AH(fdi_a_catch, fdi_h_spatial_landings)
#' @import tidyverse
...
suppressMessages(data1 <- data1 %>%
        group_by(country_code, year, vessel_length, fishing_tech, gear_type, sub_region)%>%
