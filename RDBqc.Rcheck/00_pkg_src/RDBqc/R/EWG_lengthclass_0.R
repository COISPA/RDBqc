...
#' @examples EWG_lengthclass_0(data=landing,type="l",MS="ITA",GSA=11,SP="ARA",verbose=TRUE)
#' @importFrom utils globalVariables
#' @export EWG_lengthclass_0

EWG_lengthclass_0 <- function(data,type="l",MS,GSA,SP, verbose=TRUE){
    ...
    if (FALSE) {
        ...
        EWG_lengthclass_0(data=landing,type="l",MS="ITA",GSA=18,SP="ARS", verbose=TRUE)
    }
