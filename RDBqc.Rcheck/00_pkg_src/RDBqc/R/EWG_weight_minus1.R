...
#' @examples EWG_weight_minus1(data=landing,type="l",MS="ITA",GSA=18,SP="HKE",verbose=TRUE)
#' @author Alessandro Mannini <alessandro.mannini@@ec.europa.eu>
#' @author Walter Zupa <zupa@@coispa.it>
#' @author Isabella Bitetto <bitetto@@coispa.it>
#' @importFrom utils globalVariables
#' @export EWG_weight_minus1
EWG_weight_minus1 <- function(data,type="l",MS,GSA,SP, verbose=TRUE){
    ...
    if (FALSE) {
        ...
        # data[1,"landings"] <- 0
        # data[2,"landings"] <- -1
        EWG_weight_minus1(data=landing,MS="ITA",GSA=18,SP="HKE", verbose=TRUE)
    }
