...
#' @export EWG_plot_landing_ts
#' @examples EWG_plot_landing_ts(land=landing,MS="ITA",GSA=18,SP="ARA",by="quarter")
...
EWG_plot_landing_ts <- function(land,MS,GSA,SP,by="year"){
