...
GFCM_cov_task_iii(data = task_iii, SP = "Dasyatis pastinaca",
MS = "ITA", GSA = "18")
...
### Title: Check for duplicated data rows in landings, discards and catch
###   tables
...
MEDBS_lengthclass_0(data = Landing_tab_example, type = "l",
...
MEDBS_plot_landing_ts(data = Landing_tab_example, SP = "DPS",
MS = "ITA", GSA = "GSA 9", by = "quarter")
...
MEDBS_weight_0(data = Landing_tab_example, type = "l",
SP = "DPS", MS = "ITA", GSA = "GSA 9", verbose = TRUE)
...
MEDBS_weight_minus1(data = Landing_tab_example, type = "l",
SP = "DPS", MS = "ITA", GSA = "GSA 9", verbose = TRUE)
...
MEDBS_yr_missing_length(data = Discard_tab_example, type = "d",
...
RCG_check_AL(data=data_ex, MS = "ITA", GSA = "GSA99",
