...
cleanEx()
nameEx("EWG_check_duplicates")
### * EWG_check_duplicates

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: EWG_check_duplicates
### Title: Check for duplicated data rows
### Aliases: EWG_check_duplicates

### ** Examples

EWG_check_duplicates(data=landing,type="l",MS="ITA",GSA="18",SP="ARA",verbose=TRUE)



base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("EWG_check_duplicates", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("EWG_comp_disc_YQ")
### * EWG_comp_disc_YQ

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: EWG_comp_disc_YQ
### Title: Comparison between discards in weight by quarter and -1
### Aliases: EWG_comp_disc_YQ
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("EWG_comp_disc_YQ", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("EWG_comp_disc_YQ_fishery")
### * EWG_comp_disc_YQ_fishery

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: EWG_comp_disc_YQ_fishery
### Title: Comparison between discards in weight by quarter, quarter -1 and
###   by fishery
### Aliases: EWG_comp_disc_YQ_fishery
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("EWG_comp_disc_YQ_fishery", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("EWG_comp_land_Q_VL_fishery")
### * EWG_comp_land_Q_VL_fishery

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: EWG_comp_land_Q_VL_fishery
### Title: Comparison between landings in weight by quarter and fishery
###   accounting for vessel length
### Aliases: EWG_comp_land_Q_VL_fishery
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("EWG_comp_land_Q_VL_fishery", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("EWG_comp_land_YQ")
### * EWG_comp_land_YQ

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: EWG_comp_land_YQ
### Title: Comparison between landings in weight by quarter and -1
### Aliases: EWG_comp_land_YQ
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("EWG_comp_land_YQ", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("EWG_comp_land_YQ_VL")
### * EWG_comp_land_YQ_VL

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: EWG_comp_land_YQ_VL
### Title: Comparison between landings in weight by quarter accounting for
###   vessel length
### Aliases: EWG_comp_land_YQ_VL
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("EWG_comp_land_YQ_VL", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("EWG_comp_land_YQ_fishery")
### * EWG_comp_land_YQ_fishery

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: EWG_comp_land_YQ_fishery
### Title: Comparison between landings in weight by quarter, quarter -1 and
###   by fishery
### Aliases: EWG_comp_land_YQ_fishery
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("EWG_comp_land_YQ_fishery", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("EWG_disc_mean_weight")
### * EWG_disc_mean_weight

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: EWG_disc_mean_weight
### Title: Mean weight by year,gear and fishery aggregation
### Aliases: EWG_disc_mean_weight

### ** Examples

EWG_disc_mean_weight(disc=discards,MS="ITA",GSA=18,SP="MUT")



base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("EWG_disc_mean_weight", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("EWG_land_mean_weight")
### * EWG_land_mean_weight

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: EWG_land_mean_weight
### Title: Mean weight by year,gear and fishery aggregation
### Aliases: EWG_land_mean_weight

### ** Examples

EWG_land_mean_weight(land=landing,MS="ITA",GSA=11,SP="ARA")



base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("EWG_land_mean_weight", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("EWG_length_ind")
### * EWG_length_ind
...
### Aliases: EWG_length_ind

### ** Examples

EWG_length_ind(landing,type="l",out="mean",MS=c("ITA"),
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("EWG_length_ind", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("EWG_lengthclass_0")
### * EWG_lengthclass_0

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: EWG_lengthclass_0
### Title: Length classes number 0 in landings and discards
### Aliases: EWG_lengthclass_0

### ** Examples

EWG_lengthclass_0(data=landing,type="l",MS="ITA",GSA=11,SP="ARA",verbose=TRUE)



base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("EWG_lengthclass_0", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("EWG_plot_disc_vol")
### * EWG_plot_disc_vol

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: EWG_plot_disc_vol
### Title: Plot of total discards by gear and fishery
### Aliases: EWG_plot_disc_vol

### ** Examples

EWG_plot_disc_vol(data=discards,MS="ITA",GSA=18,SP="MUT")



base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("EWG_plot_disc_vol", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("EWG_plot_discard_ts")
### * EWG_plot_discard_ts

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: EWG_plot_discard_ts
### Title: Plot of total discards
### Aliases: EWG_plot_discard_ts

### ** Examples

EWG_plot_discard_ts(disc=discards,MS="ITA",GSA=11,SP="ARA",by="quarter")



base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("EWG_plot_discard_ts", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("EWG_plot_land_vol")
### * EWG_plot_land_vol

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: EWG_plot_land_vol
### Title: Plot of total landing by gear and fishery
### Aliases: EWG_plot_land_vol

### ** Examples

EWG_plot_land_vol(data=landing,MS="ITA",GSA=11,SP="ARA")



base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("EWG_plot_land_vol", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("EWG_plot_landing_ts")
### * EWG_plot_landing_ts

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: EWG_plot_landing_ts
### Title: Plot of total landing
### Aliases: EWG_plot_landing_ts

### ** Examples

EWG_plot_landing_ts(land=landing,MS="ITA",GSA=18,SP="ARA",by="quarter")



base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("EWG_plot_landing_ts", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("EWG_weight_0")
### * EWG_weight_0
...
### Aliases: EWG_weight_0

### ** Examples

EWG_weight_0(data=landing,type="l",MS="ITA",GSA=18,SP="HKE", verbose=TRUE)



base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("EWG_weight_0", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("EWG_weight_minus1")
### * EWG_weight_minus1

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: EWG_weight_minus1
### Title: weight -1 in landings
### Aliases: EWG_weight_minus1

### ** Examples

EWG_weight_minus1(data=landing,type="l",MS="ITA",GSA=18,SP="HKE",verbose=TRUE)



base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("EWG_weight_minus1", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("EWG_yr_missing_length")
### * EWG_yr_missing_length

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: EWG_yr_missing_length
### Title: Years with missing length distributions
### Aliases: EWG_yr_missing_length

### ** Examples

EWG_yr_missing_length(data=landing,type="l",MS=c("ITA"),GSA=c("18"),SP="NEP")



base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("EWG_yr_missing_length", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("GP_check")
### * GP_check
...
check_lw(data_ex,species="Aristaeomorpha foliacea",Min=0,Max=1000)
