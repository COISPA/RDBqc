#' Check mismatching species/Catfau and Sex X maturity stages for Task VII.3.2 table
#'
...
#' @import stringr
#'
#' @examples check_species_catfau_TaskVII.3.2(task732_ex,Species732,matsex732)
#' 
#' #Clean the global environment of R
rm(list=ls(all=TRUE)) 
library(stringr) #-import
...
#Data imput 2 - species
species <- read.csv("C:/Users/Loredana Casciaro/Desktop/controlli GFCM-FDI/TEST SA/controllo_catfau.csv", sep=";")
str(species)

#Data imput 3 - species/Maturity/sex
matsex <- read.csv("C:/Users/Loredana Casciaro/Desktop/controlli GFCM-FDI/TEST SA/controllo_sex_mat.csv", sep=";")
str(matsex)
...
data$CATFAU_REV=str_sub(data$Maturity, 1, 3)
...
#Control 2 - Maturity X Sex
  ...
  return(unexpected_codes_Species_catfau,unexpected_codes_matsex)
}
