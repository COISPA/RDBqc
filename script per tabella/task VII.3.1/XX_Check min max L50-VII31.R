...
#' @export
#'
#' @examples check_minmaxl50_TaskVII.3.1(task731_ex,minmax731)



if(FALSE){#Clean the global environment of R
rm(list=ls(all=TRUE)) 
...
#Data imput 1
data1=read.csv("dc_dcrf_task_vii31_size_1st_matur.csv", sep=";",dec=".",head=T,na.strings="NA")
data1
#str(data1)

#Data imput 2
data2=read.csv("minmax-L50-taskVII.3.2.csv", sep=";",dec=".",head=T,na.strings="NA")
data2
#str(data2)
###
check_minmaxl50_TaskVII.3.1(data1,data2)
}
