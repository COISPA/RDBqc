...
#' @export
#'
#' @examples check_presence_taskII2(task22_ex,combination22)
#' 
####
rm(list=ls(all=TRUE)) 
setwd("C:\\Users\\Loredana Casciaro\\Desktop\\controlli GFCM-FDI\\TEST SA")

#Data imput dataframe1
data1=read.csv("dc_dcrf_task_ii2_catch.csv", sep=";",dec=".",head=T,na.strings="NA")
#Data imput dataframe2
data2=read.csv("combination_taskII.2.csv", sep=";",dec=".",head=T,na.strings="NA")

#FIELDS RELATED TO GSA AND FLEET SEGMENTS NEED TO BE FILLED - CF. 2_ check empty fields
###
